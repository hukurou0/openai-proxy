...
def init_user(request):
    ...
    GCS.write_to_storage(BUCKET_NAME, "usage.txt", "Total Prompt Tokens:0\nTotal Completion Tokens:0\n")
...
def main(request):
    ...
    if user_id:
        ...
        if response.status_code == 200:
            ...
            usage = GCS.read_from_storage(BUCKET_NAME, "usage.txt")
            lines = usage.split("\n")
            ...
            GCS.write_to_storage(BUCKET_NAME, "usage.txt", usage)    
